...
<html lang="en">
			...
			<div class="topbar">
				...
				<div class="topbar-left">
					<div class="text-center">
						<a href="{{ url('/home') }}" class="logo"><i class="md md-terrain"></i> <span>Admin </span></a>
					</div>
				</div>
				...
				<div class="sidebar-inner slimscrollleft">
					...
					<div id="sidebar-menu">
						<ul>
							...
							<li>
								<a href="{{ url('admin/user') }}" class="waves-effect "><i class="md md-person"></i><span> User </span></a>
							</li>
							<li>
								<a href="{{ url('admin/role') }}" class="waves-effect "><i class="md md-person"></i><span> Role </span></a>
							</li>
							<li>
								<a href="{{ url('admin/company') }}" class="waves-effect "><i class="md md-person"></i><span> Company </span></a>
							</li>
							<!--
							<li class="has_sub">
 ...
 -->
		...
		<!-- flot Chart -->
		{!! HTML::script(asset('assets/flot-chart/jquery.flot.js')); !!}
		{!! HTML::script(asset('assets/flot-chart/jquery.flot.time.js')); !!}
		{!! HTML::script(asset('assets/flot-chart/jquery.flot.tooltip.min.js')); !!}
		{!! HTML::script(asset('assets/flot-chart/jquery.flot.resize.js')); !!}
		{!! HTML::script(asset('assets/flot-chart/jquery.flot.pie.js')); !!}
		{!! HTML::script(asset('assets/flot-chart/jquery.flot.selection.js')); !!}
		{!! HTML::script(asset('assets/flot-chart/jquery.flot.stack.js')); !!}
		{!! HTML::script(asset('assets/flot-chart/jquery.flot.crosshair.js')); !!}
